...
class StatisticsPassengerTrips extends React.Component {
    ...
    userByBus(userBusData) {
        ...
        // let bresult = [];
        //
        // let usersByBus= userBusData.reduce((countData, user, index) => {
        //     if (!!countData[user.busID]) {
        //         countData[user.busID] += 1;
        //     } else {
        //         countData[user.busID] = 1;
        //
        //     }
        ...
        //     return countData;
        // }, {})
        // BTypeCounts = Object.keys(usersByBus).map(user =>{
        //
        //     return usersByBus[user]
        // })
        //
        //
        // let bid = [];
    ...
    // //getting passenger count by route
    // userByRoute(userRouteData) {
    //
    //     let RType= [];
    //     let RTypeCounts =[];
